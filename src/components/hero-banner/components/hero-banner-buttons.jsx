const HerroBannerButtons = () => {
  return ( 
    <div className="flex items-center justify-center gap-[6px] md:gap-3 lg:gap-4 w-full mt-4">
      <button 
        className="rounded-full border bg-white border-none outline-none 
        ring-1 ring-inset ring-primary-button max-w-[230px] text-[13px] 
        leading-[14.82px] gap-[3px] text-primary-button py-[8.5px] px-[14px] 
      ...
      <button 
        ...
        rounded-full bg-primary-button text-[13px] leading-[14.82px] 
